                      ...
                      <span className="features24-text4">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_QfA0fa'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature1Description ?? (
                    <Fragment>
                      <span className="features24-text6">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_PdwEvK'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature2Title ?? (
                    <Fragment>
                      <span className="features24-text2">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_LUVz3Z'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature2Description ?? (
                    <Fragment>
                      <span className="features24-text5">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_trB8tF'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature3Title ?? (
                    <Fragment>
                      <span className="features24-text3">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_w1O3gX'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature3Description ?? (
                    <Fragment>
                      <span className="features24-text1">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_y7cdtS'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
