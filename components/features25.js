                      ...
                      <span className="features25-text6">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_iI1DsL'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature1Description ?? (
                    <Fragment>
                      <span className="features25-text3">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_04Rvbd'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature2Title ?? (
                    <Fragment>
                      <span className="features25-text5">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_FXMsV5'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature2Description ?? (
                    <Fragment>
                      <span className="features25-text4">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_qaNBhk'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature3Title ?? (
                    <Fragment>
                      <span className="features25-text1">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_Aedudf'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.feature3Description ?? (
                    <Fragment>
                      <span className="features25-text2">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_oWos9d'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
