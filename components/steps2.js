          ...
          <div className="steps2-container2 thq-grid-2">
            <div className="steps2-section-header">
              <h2 className="thq-heading-2">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('text_0zBhZk'),
                  }}
                ></span>
              </h2>
              <p className="thq-body-large">
                <span
                  dangerouslySetInnerHTML={{
                    __html: translate.raw('text_xEY2h-'),
                  }}
                ></span>
              </p>
              <div className="steps2-actions">
                <button className="thq-button-filled thq-button-animated steps2-button">
                  <span className="thq-body-small">
                    <span
                      dangerouslySetInnerHTML={{
                        __html: translate.raw('text_ZUshO2'),
                      }}
                    ></span>
                  </span>
                </button>
            ...
            <div className="steps2-container3">
              <div className="steps2-container4 thq-card">
                  ...
                  {props.step1Title ?? (
                    <Fragment>
                      <span className="steps2-text29">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_C9LHhO'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.step1Description ?? (
                    <Fragment>
                      <span className="steps2-text27">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_0HhAJj'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                ...
                <label className="steps2-text15 thq-heading-3">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_ajbuZM'),
                    }}
                  ></span>
                </label>
              </div>
              <div className="steps2-container5 thq-card">
                  ...
                  {props.step2Title ?? (
                    <Fragment>
                      <span className="steps2-text31">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_AXA4tA'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.step2Description ?? (
                    <Fragment>
                      <span className="steps2-text25">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_kxeLxm'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                ...
                <label className="steps2-text18 thq-heading-3">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_zQGAUR'),
                    }}
                  ></span>
                </label>
              </div>
              <div className="steps2-container6 thq-card">
                  ...
                  {props.step3Title ?? (
                    <Fragment>
                      <span className="steps2-text28">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_o9HjeM'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.step3Description ?? (
                    <Fragment>
                      <span className="steps2-text32">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_cbJAaU'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                ...
                <label className="steps2-text21 thq-heading-3">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_TjZ0kA'),
                    }}
                  ></span>
                </label>
              </div>
              <div className="steps2-container7 thq-card">
                  ...
                  {props.step4Title ?? (
                    <Fragment>
                      <span className="steps2-text30">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_HISe98'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                  ...
                  {props.step4Description ?? (
                    <Fragment>
                      <span className="steps2-text26">
                        <span
                          dangerouslySetInnerHTML={{
                            __html: translate.raw('text_D1xtYI'),
                          }}
                        ></span>
                      </span>
                    </Fragment>
                ...
                <label className="steps2-text24 thq-heading-3">
                  <span
                    dangerouslySetInnerHTML={{
                      __html: translate.raw('text_WbNNas'),
                    }}
                  ></span>
                </label>
              </div>
